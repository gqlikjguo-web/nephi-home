...
async function loadProfile() {
  ...
  $("profileName").value = profile.propertyName || ""; $("profileAddress").value = profile.address || ""; $("profileGoogleMapsUrl").value = profile.googleMapsUrl || ""; $("profileLineUrl").value = profile.lineUrl || ""; $("profileContactInfo").value = profile.contactInfo || ""; $("profileCheckInTime").value = profile.checkInTime || ""; $("profileLatestArrivalTime").value = profile.latestArrivalTime || ""; $("profileCheckOutTime").value = profile.checkOutTime || "";
}
