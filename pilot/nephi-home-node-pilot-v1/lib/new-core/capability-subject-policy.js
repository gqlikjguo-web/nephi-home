...
const UNDERSTANDING_DESCRIPTIONS = Object.freeze({
  lodging_room_composition: "Use lodging_room_composition for the physical rooms making up a property, room type, bundle/package or identified room set, including the actual number of physical rooms. This is independent of stay dates, people capacity and requested booking quantity. Select the formal subject; property-wide scope has null catalog identity. To request the distinct formal room type names, use information_need SET room_types. Physical room counts and members do not use this detail. Never infer members, names or counts and never provide facts.",
...
const EXECUTION_POLICY = Object.freeze({
  ...
  price: { routeKind: "ANSWER", requiredGuestFields: CAPABILITY_REGISTRY.price.requiredFields, temporalRequirementClass: "stay", safetyShape: "none" },
  total_price: { routeKind: "ANSWER", requiredGuestFields: CAPABILITY_REGISTRY.total_price.requiredFields, temporalRequirementClass: "stay", safetyShape: "none" },
