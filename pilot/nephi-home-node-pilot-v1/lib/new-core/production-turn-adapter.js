...
function createNewCoreProductionTurnAdapter({
  ...
  publicBaseUrl = "",
  now = () => new Date(),
  executeTurn = executeNewCoreTurn,
  ...
  if (!providerConfig || !text(providerConfig.apiKey)) throw new TypeError("provider_api_key_required");
  if (typeof executeTurn !== "function") throw new TypeError("execute_turn_required");
