...
function cleanInput(input={}){
 ...
 return{propertyName:text(input.propertyName,100),contactName:text(input.contactName,80),phone:text(input.phone,40),email:email(input.email),address:text(input.address,300),checkInTime:validTime(input.checkInTime),checkOutTime:validTime(input.checkOutTime),line:{hasOfficialAccount:Boolean(input.line&&input.line.hasOfficialAccount),channelId:text(input.line&&input.line.channelId,80),contactLink:text(input.line&&input.line.contactLink,500)},propertyIdSuggestion:text(input.propertyIdSuggestion,48),rooms,bundles,knowledge};
}
