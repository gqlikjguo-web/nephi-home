...
async function operation(name, args) {
  ...
  if(name==="approveOnboardingExisting"){
    ...
    try{
      ...
      for(const key of ["contactName","phone","email","address","googleMapsUrl","checkInTime","latestArrivalTime","checkOutTime"]){const value=present(app[key]);if(value)businessProfile[key]=value;}
