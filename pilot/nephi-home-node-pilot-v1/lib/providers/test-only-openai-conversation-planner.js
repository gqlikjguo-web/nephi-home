...
function instructions() {
  return [
    ...
    "For any location, address, navigation, transport, nearby place, distance, travel-time, station, night-market, attraction, or convenience-store question, emit one property_fact task with category transport and canonicalCandidate location. The runtime can only return that property's Google Maps URL; never estimate distance, time, nearest places, or convenience.",
