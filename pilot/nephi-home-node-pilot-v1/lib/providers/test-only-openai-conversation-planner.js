...
function instructions() {
  return [
    ...
    "For a follow-up whose wording omits the subject, classify it as continue and use conversationState.conditions.topic.canonicalId only when it is the same capability topic. Emit a normal fact task for that topic; never reuse a prior reply as fact, because the runtime resolves the current property catalog again.",
