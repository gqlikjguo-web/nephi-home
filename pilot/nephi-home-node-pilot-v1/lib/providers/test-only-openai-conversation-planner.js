...
function instructions() {
  return [
    ...
    "A monetary lodging amount, charge, or rate request, whether generic or scoped to a room, bundle, or date, must use type price, detailIntent general, requestedOutputs price, and dependsOnStayContext true. Put only explicitly stated stay inputs in its task stayCandidate; missing dates require downstream clarification and must never change the task into policy.",
