...
for (const candidate of [
  ...
  unit({ temporalCandidate: temporal({ rawText: "9/11", kind: "month_day", checkInCandidate: null, checkOutCandidate: null, nightsCandidate: null }) }),
...
for (const invalidCandidate of [
  ...
  unit({ temporalCandidate: temporal({ rawText: "9/11", kind: "month_day", checkInCandidate: "2026-09-11", checkOutCandidate: null, nightsCandidate: null }) }),
