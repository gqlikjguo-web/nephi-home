...
(async () => {
  ...
  try {
    ...
    providers = null;
    let running = await startScopedApp();
    ...
    // Bundle creation legitimately backfills managed dates. Establish the gap
    // afterwards so this assertion isolates the following disabled-bundle update.
    await app.stop();
    app = null;
    providers = null;
