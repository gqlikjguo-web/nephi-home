...
async function fakeTurn({ input, state, sideEffectGuard, now: timestamp }) {
...
(async () => {
  ...
  const app = createApp({ providers, adminAuthRequired: true, now, runtimeEnv: { OPENAI_API_KEY: Array(33).join("x") }, newCoreManualTestExecuteTurn: fakeTurn, lineBindingEnv: {} });
