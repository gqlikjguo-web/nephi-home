...
function availability(fields,missing=[]){return{intent:"availability",route:missing.length?"clarification_needed":"auto_reply_allowed",confidence:.99,reason:"room_filter_state_test",extractedFields:fields,missingFields:missing,shouldIgnore:false,needsHuman:false};}
